"""
Django settings for noisy_leaf_dev_92950 project.
...
ROOT_URLCONF = 'noisy_leaf_dev_92950.urls'
...
WSGI_APPLICATION = 'noisy_leaf_dev_92950.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_leaf_dev_92950 API",
    "DESCRIPTION": "API documentation for noisy_leaf_dev_92950 App",
    "VERSION": "v1",
}
